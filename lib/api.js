...
class RemehaAPI {
  ...
  // ─── Hot Water (DHW) API calls ───────────────────────────────────────────────

  async setHotWaterOff(hotWaterZoneId) {
    return this._apiRequest("POST", `/hot-water-zones/${hotWaterZoneId}/modes/anti-frost`);
  }

  async setHotWaterSchedule(hotWaterZoneId) {
    return this._apiRequest("POST", `/hot-water-zones/${hotWaterZoneId}/modes/schedule`);
  }

  async setHotWaterComfort(hotWaterZoneId) {
    return this._apiRequest("POST", `/hot-water-zones/${hotWaterZoneId}/modes/continuous-comfort`);
  }

  async setHotWaterComfortSetpoint(hotWaterZoneId, setpoint) {
    return this._apiRequest("POST", `/hot-water-zones/${hotWaterZoneId}/comfort-setpoint`, {
